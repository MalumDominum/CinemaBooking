using CinemaBooking.Application.Subscriptions.Commands.CancelSubscription;
...
using CinemaBooking.Application.Subscriptions.Queries.GetSubscription;
...
using SubscriptionType = CinemaBooking.Contracts.Common.SubscriptionType;
